...
/**
 * Created by gizthon on 16/9/13. email:2013mzhou@gmail.com
 * <p>
 * des:
 */
public class AppUtils {
    ...
    public static Intent getInstallIntent(Context context, File file){
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(context, AppUtils.getAppInfo(context).getPackageName()+".fileprovider", file);
    ...
    public static class AppInfo {
        ...
        public AppInfo(String name, String versionName) {
            this.setName(name);
            this.setVersionName(versionName);
        }
...
//        }
    ...
    public static AppInfo getAppInfo(Context context) {
        ...
        AppInfo temp =  pi != null ? getBean(pm, pi) : null;
